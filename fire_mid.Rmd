...
corMat_kma <- cor(kmaHi[,2:16], use = "na.or.complete")
corMat_kma
...
kma_results <- run_univariate_models(kmaHi, "Presence", predictor_vars)
...
ptaE_results <- run_univariate_models(ptaEHi, "Presence", predictor_vars)
...
r17_results <- run_univariate_models(r17Hi, "Presence", predictor_vars)

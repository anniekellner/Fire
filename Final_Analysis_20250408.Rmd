...
In all the top models (AICc <2), FM1 is the best predictor of Occurrence. If you need to use linear regression, using FM1 only will give you fire presence/absence. 
